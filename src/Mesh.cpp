...
void Mesh::split (const int & direction, Mesh & rightMesh, Mesh & leftMesh) {
    std::vector<Vertex> leftVertices, rightVertices;
    ...
    rightMesh = Mesh(rightVertices, rightTriangles);
    leftMesh = Mesh(leftVertices, leftTriangles);
