...
**
** Created: Wed Aug 14 11:17:24 2013
...
struct qt_meta_stringdata_IntegerWidget_t {
    QByteArrayData data[3];
    char stringdata[29];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_IntegerWidget_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_IntegerWidget_t qt_meta_stringdata_IntegerWidget = {
    {
QT_MOC_LITERAL(0, 0, 13),
QT_MOC_LITERAL(1, 14, 12),
QT_MOC_LITERAL(2, 27, 0)
    },
    "IntegerWidget\0valueChanged\0\0"
};
...
void IntegerWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (IntegerWidget::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&IntegerWidget::valueChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject IntegerWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_IntegerWidget.data,
      qt_meta_data_IntegerWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_IntegerWidget.stringdata))
...
struct qt_meta_stringdata_DoubleWidget_t {
    QByteArrayData data[5];
    char stringdata[42];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_DoubleWidget_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_DoubleWidget_t qt_meta_stringdata_DoubleWidget = {
    {
QT_MOC_LITERAL(0, 0, 12),
QT_MOC_LITERAL(1, 13, 12),
QT_MOC_LITERAL(2, 26, 0),
QT_MOC_LITERAL(3, 27, 11),
QT_MOC_LITERAL(4, 39, 1)
    },
    "DoubleWidget\0valueChanged\0\0changeValue\0"
    "i\0"
};
#undef QT_MOC_LITERAL
...
void DoubleWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            typedef void (DoubleWidget::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DoubleWidget::valueChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject DoubleWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_DoubleWidget.data,
      qt_meta_data_DoubleWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DoubleWidget.stringdata))
